...
export const GridsterConfigService: GridsterConfig = {
  ...
  draggable: {
    ...
    // Essentially this GridsterConfigService object is getting merged with the gridsterOptions that we pass into the component with GridsterUtils.merge.
    // But since, the merge is checking if properties.hasOwnProperty(p),
    // if we pass in two items, we need to have two+ items here to make it to work with the logic
    ignoreContentClass: ['gridster-disable-drag', 'gridster-disable-drag-2', 'gridster-disable-drag-3', 'gridster-disable-drag-4', 'gridster-disable-drag-5'], // default content class to ignore the drag event from
