...
/**
 * Model for Combined climate scenario column option
 */
export class CombinedClimateScenariosColumnOption extends ClimateScenariosColumnOption {

    public static CONFIG_TYPE = 'cdClimateScenarioSettings';

    get configType(): string {
        return CombinedClimateScenariosColumnOption.CONFIG_TYPE;
    }
    /**
    ...
    initialize(defaultSettings: any): void {
        ...
        const defaultScenario = climateScenarioAvailableOptions.getCombinedClimateDefaultOption();
        if(defaultScenario){
