...
import {ReturnFXAttributionSpriteletLauncherService} from '@services/spritelet-launcher/return-fx-attribution-spritelet-launcher.service';
import {ColumnSet} from '@blk/explore-ui-column-option';

/**
 * Test cases for ReturnFXAttributionSpriteletLauncherService
 */
describe('ReturnFXAttributionSpriteletLauncherService', () => {
    let service: ReturnFXAttributionSpriteletLauncherService;
    ...
    beforeAll(() => {
        ...
        service = TestBed.inject(ReturnFXAttributionSpriteletLauncherService);
    });

    it('should be created', () => {
        expect(service).toBeTruthy();
        expect(service.getSpriteletActionKey()).toBe(PerformanceConstants.SPRITELET_EVENTS.RETURN_FX_ATTRIBUTION);
    });
    ...
    it('test launchSpritelet', (done)  => {
        ...
        const spriteletEvent = new SpriteletEvent(PerformanceConstants.SPRITELET_EVENTS.RETURN_FX_ATTRIBUTION, params);
        ...
        expect(spriteletWidget.configType).toBe(WidgetConfigType.RETURNS_FX_ATTRIBUTION);
        expect(spriteletWidget.title).toBe('Performance Details for FX Attribution');
