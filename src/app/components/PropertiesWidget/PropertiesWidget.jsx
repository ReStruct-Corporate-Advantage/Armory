...
const PropertiesWidget = props => {
  ...
  return (
    <div className="c-Widget c-PropertiesWidget d-flex flex-column flex-nowrap h-50">
      <SectionHeader {...props} />
      <ToolBox toolsConfig={TOOLS_CONFIG.CODE_PROPERTIES_TOOLS} handlers={[{name: "EditProperties", handler: toggleEditMode, currentValue: editMode, type: "onClick"}]} />
      <PropsForm selectedComponent={selectedComponent} editMode={editMode} />
    </div>
  );
};
