    ...
    ADMIN_ACTIONS: {
        ...
        parts: [
                ...
                subOptions: [
                    {
                        ...
                        action: (componentsConfig, dispatchComponentsConfig, dispatchLevels, dispatchSelectedComponent, navigate, userDetails) => navigate(`/${userDetails.username}/manage/component/add`)
                    },
                    {
                        ...
                        action: (componentsConfig, dispatchComponentsConfig, dispatchLevels, dispatchSelectedComponent, navigate, userDetails) => navigate(`/${userDetails.username}/manage/component/update`)
                    }
                ],
            ...
            },
            {
                ...
                action: (componentsConfig, dispatchComponentsConfig, dispatchLevels, dispatchSelectedComponent, navigate, userDetails) => navigate(`/${userDetails.username}/manage/project`)
            }
        ]
    },
    RESUMPTION_ACTIONS: {
        ...
        parts: [
            {name: "ResumptionHeader", type: "header", classes: "section-header w-100 mb-0", text: "Let's resume where your left..."},
            {
                ...
                action: (componentsConfig, dispatchComponentsConfig, dispatchLevels, dispatchSelectedComponent, navigate, userDetails) => navigate(`/${userDetails.username}/component`)
            },
            {
                ...
                action: (componentsConfig, dispatchComponentsConfig, dispatchLevels, dispatchSelectedComponent, navigate, userDetails) => navigate(`/${userDetails.username}/page`)
            },
            {
                ...
                action: (componentsConfig, dispatchComponentsConfig, dispatchLevels, dispatchSelectedComponent, navigate, userDetails) => navigate(`/${userDetails.username}/project`)
            }
        ]
    },
    NEW_ACTIONS: {
        ...
        parts: [
            ...
            },
            {
                ...
                action: (componentsConfig, dispatchComponentsConfig, dispatchLevels, dispatchSelectedComponent, navigate, userDetails) => {
                    ...
                    component.createContainer(userDetails)
                        .then(res => {
                            ...
                            navigate(`/${userDetails.username}/component`)
                        });
                }
            },
            {name: "OptionSeparator", type: "p", classes: "option-separator col-6 mx-auto mb-5", text: "Or"},
            {
                ...
                action: (componentsConfig, dispatchComponentsConfig, dispatchLevels, dispatchSelectedComponent, navigate, userDetails) => navigate(`/${userDetails.username}/template`)
            }
        ]
    }
}
