...
export const DISPATCH_DROP_LOCATION = "DISPATCH_DROP_LOCATION";
...
export const dispatchDropLocation = dropLocatiom => {
    return {
        type: DISPATCH_DROP_LOCATION,
        payload: {dropLocatiom}
    }
}
